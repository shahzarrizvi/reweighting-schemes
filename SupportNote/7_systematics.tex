...
\begin{figure}[h!]
  \centering
  \subfloat[]{\includegraphics[page=2,width=0.45\textwidth]{figures/systAlphaS.pdf}}
  \subfloat[]{\includegraphics[page=2,width=0.45\textwidth]{figures/syst_alphaS.pdf}} \\
  
  \caption{Spread of the impact of 100 pdf variations per bin (left) and impact of systematic uncertainty as RMS of these 100 results (right) on dilepton \pt.}
  \label{fig:PDF_RMS}
\end{figure}
