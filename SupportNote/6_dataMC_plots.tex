...
\begin{figure}[h!]
  ...
  \subfloat[Leading muon]{\includegraphics[page=40,width=0.45\textwidth]{figures/ZjetOmnifoldMCDataComp.pdf}} \\
  ...
  \subfloat[Sub-leading muon]{\includegraphics[page=44,width=0.45\textwidth]{figures/ZjetOmnifoldMCDataComp.pdf}}
...
\begin{figure}[h!]
  ...
  \subfloat[Leading track jet]{\includegraphics[page=80,width=0.45\textwidth]{figures/ZjetOmnifoldMCDataComp.pdf}} \\
  ...
  \subfloat[Sub-leading track jet]{\includegraphics[page=96,width=0.45\textwidth]{figures/ZjetOmnifoldMCDataComp.pdf}}
