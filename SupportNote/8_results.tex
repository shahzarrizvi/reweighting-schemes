...
\item 
   ...
   IBU requires a predefined binning, which has been derived for each observable as described in appendix~\todo{LAURA}. This binning is presented in table~\todo{LAURA}.
