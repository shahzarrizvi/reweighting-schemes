...
Following the selection, contributions from processes other than strong $Z$+jet production is negligible as can be seen in appendix~\ref{app:bkg-processes}.
