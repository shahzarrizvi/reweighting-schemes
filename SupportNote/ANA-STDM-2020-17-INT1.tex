...
\input{9_checks_multifold}

\clearpage

\section{Results using simulation}
\input{10_results_sim_multifold}
...
\section{Unfolding checks}
\input{11_checks_omnifold}

\section{Results using simulation}
\input{12_results_sim_omnifold}
...
%% Appendix G-L: Deterministic and stochastic stress tests
\input{appendix_stress_tests}
\clearpage

%% Appendix M-N: Model dependence for UniFold & MultiFold
...
%% Appendix P: Number of iterations
\input{appendix_num_iterations}
\clearpage

%% Appendix Q: MultiFold uncerts
\input{appendix_multifolduncertplots}
\clearpage
